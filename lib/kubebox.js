...
const { Dashboard, login, namespaces, NavBar, spinner: { until }, setContent, Plugins } = require('./ui/ui');
...
class Kubebox extends EventEmitter {
  ...
  constructor(screen, server) {
    ...
    // const plugins = new Plugins({screen, navbar, status, client})
    // navbar.add({ title: 'Plugins', listener: plugins })
